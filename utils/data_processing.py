...
class DataProcessor:
    ...
    def get_related_symptoms(self, symptom, top_n=5):
        """
        Get related symptoms for a given symptom based on co-occurrence.
        ...
        try:
            ...
            scores = self.symptom_cooccurrence[idx]
            ...
            # If symptom not found in dataset
            return []
